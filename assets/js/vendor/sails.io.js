...
!function (e) {
  ...
  return function e(t, n, r) {
    ...
    }, {"./on": 4, "component-bind": 7, "component-emitter": 8, debug: 9, "has-binary": 35, "socket.io-parser": 43, "to-array": 47}],
    ...
    }, {"../transport": 13, "component-inherit": 20, debug: 21, "engine.io-parser": 24, parseqs: 32, xmlhttprequest: 19}],
...
(function () {
  ...
  function SailsIOClient(io) {
    ...
    if (!io) {
      throw new Error('`sails.io.js` requires a socket.io client, but `io` was not passed in.');
    }
